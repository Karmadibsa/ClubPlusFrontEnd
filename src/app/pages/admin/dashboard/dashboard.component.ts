...
import {MembreService} from '../../../service/crud/membre.service'; // Pour les opérations liées aux membres
import {EventService} from '../../../service/crud/event.service'; // Pour les opérations liées aux événements
